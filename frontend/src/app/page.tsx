...
const experienceTiles = [
  {
    ...
    copy: "Hand-selected Alocasias and Syngoniums acclimated to Reading homes, styled in custom moss poles.",
    action: "Browse inventory",
  },
  {
    title: "Greenhouse concierge",
    copy: "Private visits, cutting previews, and bespoke planting in our magical 3D corm pots.",
    action: "Plan a visit",
  },
  {
    title: "Gather & learn",
    copy: "Micro-workshops, evening salons, and live timelapse screenings with tea service.",
    action: "See events",
  },
];
      ...
      <header className="sticky top-0 z-30 border-b border-emerald-100/60 bg-white/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 text-sm font-semibold text-slate-700 lg:px-12">
          ...
          <div className="flex items-center gap-4">
            <Link href="/about" className="text-slate-600 hover:text-emerald-700">
              About
            </Link>
        ...
        <section className="grid gap-10 rounded-3xl border border-emerald-200 bg-white/80 p-10 shadow-2xl shadow-emerald-100/40 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600">
              We are a concierge plant atelier crafting stories with collector-grade aroids, dreamy
              3D-printed corm pots, and attentive watering rituals for your home or studio.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-8 text-white shadow-emerald-900/40">
            ...
            <div className="relative flex flex-col items-center gap-6 text-center">
              ...
              <p className="text-lg text-emerald-100">
                Shop visits · Care concierge · Remote monitoring · Rare aroid showcases
              </p>
              <div className="flex flex-wrap justify-center gap-3 text-xs uppercase tracking-[0.3em] text-emerald-200">
                ...
                <span className="rounded-full border border-white/10 px-4 py-2">LIVE FEED</span>
                <span className="rounded-full border border-white/10 px-4 py-2">EVENTS</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-8">
          <div className="grid gap-6 lg:grid-cols-3">
            {experienceTiles.map((tile) => (
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-emerald-500">Experiences</p>
